...
const resizeVideo = (originalVideoPath, targetVideoPath) => {
  ...
  /**
   *  Optimization of FFmpeg of utilization of CPU
   *  1. nice -> Each process you open up has this `nice` value
   *  2. -threads -> Define how many thread we utilize
   *  3. ps -p 29344 -o nice -> To get the nice value of PID
   */
